                                 ...
                                 <div class="form-group">
                                     ...
                                     <p class="help-block">input picture here.</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="táo">táo</option></select>
<p class="help-block">input category here.</p>
                                        </div>
                                        <div class="form-group">
                                     ...
                                     <p class="help-block">input price here.</p>
                                        </div>
                                            
                                    
                                 
                                        <button type="submit" class="btn btn-info" name="txtsub">insert</button>
                                    ...
                                    <?php
                                        ...
                                        include('control.php');
                                        $get_data=new data();
                                        $insert=$get_data->insert_product($_POST['txtname'],
                                                                   $_POST['txtnumber'],
                                                                   $_FILES['txtpic'],
                                        ...
                                        if(isset($_POST['txtsub']))
                                                     {
                                                        ...
                                                        'upload/'.$_FILES['txtpic']['name']);

                                                
                                                           if($insert)
                                                                    echo "<script> alert('sản phẩm đã thêm thành công')</script>";
                                                                    else echo "<script> alert('sản phammr chưa thêm được')</script>";
                                                     }
